...
INSERT INTO [Hero] ([Id], [Classe], [Endurance], [Force], [Image], [Nom], [Race], [TeamId])
...
INSERT INTO [users] ([Id], [DateOfBirth], [Mail], [NomHero], [Password])
...
UPDATE [Hero] SET [Endurance] = 5, [Force] = 2, [Image] = N'.../Images/nainVoleur.jpg', [Nom] = N'Torain', [UserId] = 2
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Classe', N'Endurance', N'Force', N'Image', N'Nom', N'Race', N'UserId') AND [object_id] = OBJECT_ID(N'[Hero]'))
    SET IDENTITY_INSERT [Hero] ON;
INSERT INTO [Hero] ([Id], [Classe], [Endurance], [Force], [Image], [Nom], [Race], [UserId])
...
INSERT INTO [Teams] ([Id], [Score], [UserId])
VALUES (1, 0, 2),
(2, 15, 1),
(3, 10, 1),
(4, 10, 1),
...
INSERT INTO [Dungeon] ([Id], [Image], [Level], [Name])
...
INSERT INTO [Monster] ([Nom], [Avatar], [Endurance], [Force], [Race])
...
INSERT INTO [DungeonMonstre] ([DungeonsId], [MonstresNom], [NbrMonstre])
...
UPDATE [Hero] SET [Classe] = N'Magicien', [Race] = N'Nain'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Classe] = N'Guerrier', [Race] = N'Orc'
WHERE [Id] = 2;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Classe] = N'Archer', [Race] = N'Elf'
WHERE [Id] = 3;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Classe] = N'Magicien', [Race] = N'Humain'
WHERE [Id] = 4;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Classe] = N'Voleur', [Race] = N'Nain'
WHERE [Id] = 5;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Classe] = N'Archer', [Race] = N'Orc'
WHERE [Id] = 6;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Classe] = N'Guerrier', [Nom] = N'Aldin', [Race] = N'Elf'
WHERE [Id] = 7;
SELECT @@ROWCOUNT;
...
INSERT INTO [HeroTeam] ([IdHero], [IdTeam])
VALUES (1, 7),
(2, 7),
(3, 7),
(4, 7),
...
UPDATE [Hero] SET [Image] = N'/Images/nainVoleur.jpg'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Image] = N'/Images/orcGuerrier.jpg'
WHERE [Id] = 2;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Image] = N'/Images/elfeArcher.jpg'
WHERE [Id] = 3;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Image] = N'/Images/humainSorcier.jpg'
WHERE [Id] = 4;
SELECT @@ROWCOUNT;
...
UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/spider.jpg'
WHERE [Nom] = N'Araignée';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/bat.jpg'
WHERE [Nom] = N'Chauve - Souris';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/DarkLord.png'
WHERE [Nom] = N'Dark Lord';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/efrit.jpg'
WHERE [Nom] = N'Efrit';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/Fafnir.png'
WHERE [Nom] = N'Fafnir';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/Bone_Golem.jpg'
WHERE [Nom] = N'Golem d’os';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/grougaloragran.jpg'
WHERE [Nom] = N'Grougaloragran';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/hydra.jpg'
WHERE [Nom] = N'Hydre';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/kobold.jpg'
WHERE [Nom] = N'Kobold';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/wolf.jpg'
WHERE [Nom] = N'Loup Geant';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/ogre.jpg'
WHERE [Nom] = N'Ogre';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/serwaul.jpeg'
WHERE [Nom] = N'Serwaul';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/wyvern.jpg'
WHERE [Nom] = N'Vouivre';
SELECT @@ROWCOUNT;
...
UPDATE [Dungeon] SET [Image] = N'/Images/cover.jpg'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Image] = N'/Images/IceDJ.jpg'
WHERE [Id] = 2;
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Image] = N'/Images/Desert.jpg'
WHERE [Id] = 3;
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Image] = N'/Images/Forest.jpg'
WHERE [Id] = 4;
SELECT @@ROWCOUNT;
...
UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/spider.png'
WHERE [Nom] = N'Araignée';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/bat.png'
WHERE [Nom] = N'Chauve - Souris';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/efrit.png'
WHERE [Nom] = N'Efrit';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/grougaloragran.png'
WHERE [Nom] = N'Grougaloragran';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/hydra.png'
WHERE [Nom] = N'Hydre';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/kobold.png'
WHERE [Nom] = N'Kobold';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/wolf.png'
WHERE [Nom] = N'Loup Geant';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/ogre.png'
WHERE [Nom] = N'Ogre';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/serwaul.png'
WHERE [Nom] = N'Serwaul';
SELECT @@ROWCOUNT;

GO

UPDATE [Monster] SET [Avatar] = N'/Images/Monstre/wyvern.png'
WHERE [Nom] = N'Vouivre';
SELECT @@ROWCOUNT;
...
INSERT INTO [AspNetUsers] ([Id], [AccessFailedCount], [ConcurrencyStamp], [DateOfBirth], [Email], [EmailConfirmed], [LockoutEnabled], [LockoutEnd], [NomHero], [NormalizedEmail], [NormalizedUserName], [PasswordHash], [PhoneNumber], [PhoneNumberConfirmed], [SecurityStamp], [TwoFactorEnabled], [UserName])
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'a362e03d-ea61-46f9-b6af-0cd906e2e0c4', [SecurityStamp] = N'e4583bae-1a60-4f62-925d-ed6efeea11f2', [UserName] = N'admin'
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'9fab3981-2054-41cb-8cc7-023728b98ea6', [SecurityStamp] = N'5850321a-537b-4a42-aafd-e4c9521647a9', [UserName] = N'Ghostkiller'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'db788135-60ef-4efd-8663-d04c5c82348c', [SecurityStamp] = N'250f53d0-bb5a-4ddc-b01c-cc0319337803', [UserName] = N'Ghost'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'bd8bc52e-9cd6-49c3-a85f-0e5addda782b', [SecurityStamp] = N'2799fc23-caa0-471f-8313-d8d6ce73006b', [UserName] = N'LOU'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'606ceea4-20af-4792-b1bd-d3f7dea5fc13', [SecurityStamp] = N'c0ee5d40-f56f-4e42-9319-636d574b20e0', [UserName] = N'Icare'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'cb273942-8183-49a6-b947-22ade2620a43', [SecurityStamp] = N'5e0e1c86-c351-4c0d-8e77-6a49939e858f'
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'001e41fb-559b-463e-8260-6bb3e0debc08', [SecurityStamp] = N'2ed82c1d-4218-4ee1-b17a-88d19f22adec'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c5f7f81f-9c11-4108-bf4c-f2a7fe70053b', [SecurityStamp] = N'a43534e7-dc01-4009-9c78-85c9e3175f2a'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'4f0c379f-8238-475f-aeab-ab28ee1e7ad9', [SecurityStamp] = N'5cd83424-79d9-424b-a48e-1a561123e51a'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'73228c19-b109-40db-9357-6478a99b4596', [SecurityStamp] = N'79fd8c91-d387-4911-92c5-edf5a3ae25af'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'0fcc7844-f287-46e0-b4b3-3ba77e436e58', [SecurityStamp] = N'c0f4e305-6d8e-4a55-bcb3-f100c7644fda'
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'00a56257-95d0-456f-942c-fba8245b1662', [SecurityStamp] = N'ebec94cc-ecf1-4fd1-b2a3-8174ff0a2f15'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'3ccded1b-26a7-43b3-9e46-12e9e242b445', [SecurityStamp] = N'd8f5f944-d139-464a-9a64-4ddf947d945e'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'a201c5f6-ff43-4ffa-8ae7-6a35cb321a99', [SecurityStamp] = N'6d18f4cb-a6d2-4aae-83b1-7fe4adce60b6'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'64ffc414-1fdf-468e-bd11-9c411e7160aa', [SecurityStamp] = N'fadcab0c-8172-49f3-b5fa-11b65d7baa69'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Lvl] = 5.0E0
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Lvl] = 3.0E0
WHERE [Id] = 2;
SELECT @@ROWCOUNT;

GO

UPDATE [Hero] SET [Lvl] = 2.0E0
WHERE [Id] = 3;
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'397a6279-9460-4f62-9fe1-e9263b5a316f', [SecurityStamp] = N'4d7ffc8a-bc90-487d-8123-68c183a328c5'
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c5003f01-f239-4fdb-bc59-fca18d936b90', [SecurityStamp] = N'55d98ba1-e30e-41cc-bb26-2f151b7ea56c'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'3f099541-5e21-48f1-88c3-9965fb947066', [SecurityStamp] = N'eb3fca14-7416-44b7-8c69-9f07f7d2b910'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'7ca07714-14fc-440b-9379-c75d8360e813', [SecurityStamp] = N'd1ac623e-b70e-4219-9442-333dab8caed4'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'b9500854-2eb7-498f-a5b0-5b8af98898cc', [SecurityStamp] = N'ed2155d0-6616-488e-b289-4e63cffc7aa0'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c80dbcc3-9258-4509-a444-71ba70bbedd9', [SecurityStamp] = N'78e9b0c5-7f42-4333-90ee-744c5eb866c4'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'269ab791-1f43-46d8-a76d-d39049febf80', [SecurityStamp] = N'68226bdc-00ac-48c7-b0dd-f5e157ac7da2'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'd087c347-c88d-43e4-bd52-81f901477177', [SecurityStamp] = N'58b9fb6e-eff7-4c72-ba84-50b3a3fe04ad'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c12f825f-95a6-48a4-8113-162248605926', [SecurityStamp] = N'9c6499e8-1bf1-4aa4-b587-5f07a5d7c1b5'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'22f8892d-a92e-4e20-92d9-00ba2af0ade2', [SecurityStamp] = N'04fa5393-9161-4b75-8e71-036213193b9a'
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'25011ef7-bd3a-4a01-a155-274fb12bb117', [SecurityStamp] = N'01d22395-1e3c-48ad-8d56-3f236632258a'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'3599d339-b194-4ef5-ab21-08d1450f0759', [SecurityStamp] = N'ab87a78f-5fb3-408b-b437-bb7d71704819'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'd7228cbd-00ec-4e8e-9efc-fa2326297f85', [SecurityStamp] = N'785be137-ee57-4886-91b4-40eb9994f7d2'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'61f0a2b7-1c32-4a4a-91fd-8b0399364f44', [SecurityStamp] = N'4d749860-d7b8-44f6-88ff-5ad4ed7a9b0f'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'83ab4aac-323c-44fe-92c4-db10d8ec7bea', [SecurityStamp] = N'6dca74ae-40a4-42bc-98d0-288af7d790ff'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Classe', N'Endurance', N'Force', N'Image', N'Lvl', N'Nom', N'Race', N'UserId') AND [object_id] = OBJECT_ID(N'[Hero]'))
    SET IDENTITY_INSERT [Hero] ON;
INSERT INTO [Hero] ([Id], [Classe], [Endurance], [Force], [Image], [Lvl], [Nom], [Race], [UserId])
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'1a39948f-0a0a-405b-af07-565c72ac77e8', [NormalizedEmail] = N'GHOSTKILLER598R@GMAIL.COM', [NormalizedUserName] = N'GHOSTKILLER', [SecurityStamp] = N'4c82b8de-9df5-471a-8046-d13c67e0861b'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c153c4bd-08c1-468d-af6c-0f0672d322d8', [NormalizedEmail] = N'NATHANLOMBARDELLI@HOTMAIL.COM', [NormalizedUserName] = N'GHOST', [SecurityStamp] = N'd05018e4-28f9-4036-882d-1daa40d75c4f'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'98237ade-97aa-456b-87df-c126254758eb', [NormalizedEmail] = N'FABRICEETVERODEHOUS@HOTMAIL.COM', [NormalizedUserName] = N'LOU', [SecurityStamp] = N'edd8964b-4a02-4306-aada-1d1f55f83381'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'4da1f5bb-251a-4c06-8218-c53de54760b7', [NormalizedEmail] = N'DEJARDINVERONIQUE.B159@HOTMAIL.COM', [NormalizedUserName] = N'ICARE', [SecurityStamp] = N'2b066bae-b728-4534-8f40-1cc7ff4a2e8f'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'ca39eebc-111a-4053-abc1-40d0a24f9009', [Email] = N'admin@hotmail.com', [NormalizedEmail] = N'ADMIN@HOTMAIL.COM', [NormalizedUserName] = N'ADMIN', [SecurityStamp] = N'b1e55a5d-1938-42c1-8f78-8d385f0b9118'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'029ab6f3-ad04-44c5-b681-68a47c20e42a', [SecurityStamp] = N'fec2b6df-9c71-4c8b-9550-eb726488bbe1'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'b6d666c2-2c11-4812-b71d-d006cac73068', [SecurityStamp] = N'8eb0a70d-2a96-4fe5-bda1-e86e66ccd13f'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'06edc9dc-e6be-404c-b76b-1f3ea33eec65', [SecurityStamp] = N'bdfd3798-3306-466c-aa6f-5ab164a6ec0a'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'9b83cf13-944a-4cb0-a5f1-3ddb7f6dae66', [SecurityStamp] = N'2d88e0dd-3df9-46a0-aa08-fe90668b21b8'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'b4a7c0ff-8376-45ac-b275-fdc46daeb85b', [SecurityStamp] = N'3ed7e422-439b-4142-982f-f8b20561b96b'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'2f57139d-8db7-4386-975f-832322963f5c', [SecurityStamp] = N'5ea72779-0b28-4b16-a367-a367ef20be80'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'ad993eff-1842-4edb-b97d-f7949dea7f6c', [SecurityStamp] = N'2026a6f1-e209-4e3a-b5b5-6b91ef5767ba'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'72002d0e-aef3-47b2-816d-06f1c265239c', [SecurityStamp] = N'b8109846-3258-447c-b8b8-c8846ad2d7fd'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'f76b3833-1e99-405f-9aa3-49a47ec0cad3', [SecurityStamp] = N'edc95a7d-2984-4739-97c2-553e18007b0c'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'bc6e86cc-86d9-40f8-81ed-03d01262c3d4', [SecurityStamp] = N'd0433e47-e67d-45f9-8c06-3cd2194c388a'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'4d39deee-7c2b-4740-9f4a-c9bf1e2e0384', [SecurityStamp] = N'd2876380-d31d-4eb7-a6f0-f5956e9a4633'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'7759c69b-e3e4-4d87-a247-9052aefa2d51', [SecurityStamp] = N'490bbcb0-53e9-4776-a753-9672133207c1'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'ebe85c06-b875-4d04-968d-7cc03e876fdc', [SecurityStamp] = N'10d461b8-f612-45ce-8fbb-0770f3dcee0b'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'55c748f6-7cc9-4a54-9ed3-b1093cedbc2a', [SecurityStamp] = N'0116e8ab-903e-42da-8f39-b423faafc67a'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'HeroesId', N'TeamsId') AND [object_id] = OBJECT_ID(N'[HeroTeam]'))
    SET IDENTITY_INSERT [HeroTeam] ON;
INSERT INTO [HeroTeam] ([HeroesId], [TeamsId])
VALUES (N'1', N'7'),
(N'2', N'7'),
(N'3', N'7'),
(N'4', N'7'),
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'0e8ac540-613f-4660-a65a-1965d0fd1d29', [SecurityStamp] = N'f25735ab-91c1-4852-b770-f715395f9f32'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c0c1d1f1-2f9b-47ec-8ea3-fb0f760705d2', [SecurityStamp] = N'cb360540-6138-4771-ae95-5e4885aacee5'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'67fbdaa9-e61e-41aa-9080-0707c105185d', [SecurityStamp] = N'da4e78a2-f6ab-4e2a-9627-982e79a3f942'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'dc0632f8-0d28-4298-a980-5a91a861e802', [SecurityStamp] = N'f679ecfe-0b36-41c0-a1c5-8b1309fcae4d'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'dcae25a3-83c1-4dd6-bd28-d5d557ca1c96', [SecurityStamp] = N'dc7d860e-ee4f-49cd-bc6b-5d67feacbb75'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;

GO

UPDATE [Teams] SET [UserId] = N'2'
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;
...
UPDATE [Teams] SET [UserId] = N'4'
WHERE [Id] = N'8';
SELECT @@ROWCOUNT;

GO

UPDATE [Teams] SET [UserId] = N'3'
WHERE [Id] = N'9';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'00b58f01-1c52-4961-9aac-a0209f63ac9e', [SecurityStamp] = N'9ff461ea-6f05-48bb-ba9b-14e266757025'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'16fc0922-f99f-433c-914f-ed25eae75c7f', [SecurityStamp] = N'44b9ba06-c4bb-457e-bac8-e7daae102ca2'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'b63b218e-224f-475e-90f7-6a88cbd26418', [SecurityStamp] = N'50a071da-af95-4d76-a4ce-cfbfb3449747'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'005ce9ae-a83d-4598-bfdc-14df32ae6133', [SecurityStamp] = N'1c9d3321-c8bf-43cf-9ace-b1a6647b7bac'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'890a6d8b-b455-483d-a031-96480837d15a', [SecurityStamp] = N'cb2acd60-68d8-47cd-97ff-f1441e386f4e'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;

GO

UPDATE [Teams] SET [UserId1] = NULL
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'23b8b436-fd53-49b5-9f9f-5a8cace5ad5a', [SecurityStamp] = N'ee155784-b60e-41ab-9cf6-ab440fc40e9d'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'd5cce517-d3fa-497b-8afe-7cbce80b40dd', [SecurityStamp] = N'f299203a-e8c3-4531-a7e0-ecba411c0f75'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'3174b0b5-70ef-4532-b3a2-a79094237cbd', [SecurityStamp] = N'34a2ade4-26d7-4b9f-bcb2-bb9a85a18412'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'b64aeb49-9faf-4106-8a33-a6e036323bb6', [SecurityStamp] = N'7debf448-7a1e-4fe9-b325-aac79bed2358'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'9c2aa1f5-54a2-4979-94d3-bc41d54ab3cf', [SecurityStamp] = N'31109232-f1fd-4149-acdd-467721553485'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'6310a63f-e8a5-42f1-a2b3-7ca63a69c724', [SecurityStamp] = N'127cb51f-c0cf-4ff2-957a-de5266d41070'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'1c85dc0e-ca40-4b7e-ba99-c9b907b740e1', [SecurityStamp] = N'c678213c-e702-4807-9fdc-46cecad28ba8'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'cf696099-bfbe-4254-8de7-19562491d130', [SecurityStamp] = N'9ba6dcb6-c9fe-40ca-9abe-37d05004384f'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'56f5f78a-c788-40ed-a4bf-17e07f0d02b3', [SecurityStamp] = N'7527be44-0999-435f-ab08-9d66930a393e'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'168967ef-70f5-4f66-91a5-98e74bd6bd28', [SecurityStamp] = N'8b5bfb4d-1bf3-4bbf-873c-376f0f5d7ad6'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;

GO

UPDATE [Teams] SET [UserId] = N'5'
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;
...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'53ca4211-71ae-4129-b7df-62ea81080894', [SecurityStamp] = N'd292437a-4e11-4ec8-8d0a-5df8f559a4fc'
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'dc12d4a4-1fa2-40be-8759-0726a2e996b6', [SecurityStamp] = N'a40ddb9b-c733-43b0-9de0-4e39ba4b189c'
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'168a633f-e4ed-43ce-b2df-e266aceae796', [SecurityStamp] = N'b6314b50-0d43-441f-8c02-4c6d022e2689'
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'8b35fa21-0550-4654-8e50-85bc697f55b7', [SecurityStamp] = N'2353d683-257d-4f8e-961b-f730b726b14b'
WHERE [Id] = N'5';
SELECT @@ROWCOUNT;

GO

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'e827adb0-2d77-431f-a41b-90e20b790cce', [SecurityStamp] = N'9bbbe050-dfc1-4f77-82e8-438cff293d63'
WHERE [Id] = N'b74ddd14-6340-4840-95c2-db12554843e5';
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Level] = 24
WHERE [Id] = N'1';
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Level] = 42
WHERE [Id] = N'2';
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Level] = 55
WHERE [Id] = N'3';
SELECT @@ROWCOUNT;

GO

UPDATE [Dungeon] SET [Level] = 10
WHERE [Id] = N'4';
SELECT @@ROWCOUNT;
